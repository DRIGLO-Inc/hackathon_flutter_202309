...
class $AssetsImagesPngGen {
  ...
  /// File path: assets/images/png/main_header_image.png
  AssetGenImage get mainHeaderImage =>
      const AssetGenImage('assets/images/png/main_header_image.png');

  /// File path: assets/images/png/main_image.png
...
class $AssetsImagesSvgGen {
  ...
  /// File path: assets/images/svg/user_icon.svg
  SvgGenImage get userIcon =>
      const SvgGenImage('assets/images/svg/user_icon.svg');

  /// List of all assets
  List<SvgGenImage> get values => [userIcon];
}
